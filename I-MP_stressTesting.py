...
from utils.utils import evaluate_update,check_time_difference, write_stress_test_to_csv
                ...
                while set_planning:
                    ...
                    if (target_point - agent_state['pos']).length <= 0.005:
                        ...
                        if target_sequence == len(target_points):
                            ...
                            task_progress = 1
                            write_stress_test_to_csv(row['test_condition'], object_num, fixed_prob, task_progress, mission_to_be_completed, thread)
                            break
                        else:
                            target_point = Vector(target_points[target_sequence])
