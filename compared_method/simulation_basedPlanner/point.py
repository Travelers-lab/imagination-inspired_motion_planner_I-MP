...
class ControlPointGenerator:
    ...
    def update_control_points(self, base_position, start_position, target_position, point_cloud):
        """
        ...
        for cluster in clusters:
            ...
            if center is not None:
                ...
                line_vector = self.target_position - self.start_position
        ...
        return self.basic_control_points
...
if __name__ == "__main__":
    ...
    updated_points = generator.update_control_points(base, start, target, point_cloud)
