            ...
            while set_planning:
                ...
                if (target_point - agent_state['pos']).length <= 0.015:
                    ...
                    if target_sequence == len(target_points):
                        ...
                        write_data_to_csv(row['test_condition'], 'simulation_based', len(target_points), evaluate_metrics)
            ...
            while set_planning:
                ...
                if (target_point - agent_state['pos']).length <= 0.005:
                    ...
                    if target_sequence == len(target_points):
                        print("complete the task!")
                        evaluate_metrics['task_progress'] = 1
                        write_data_to_csv(row['test_condition'], 'imagination_based', len(target_points), evaluate_metrics)
                        break
                    else:
                        target_point = Vector(target_points[target_sequence])
            ...
            while set_planning:
                ...
                if (target_point - agent_state['pos']).length <= 0.005:
                    ...
                    if target_sequence == len(target_points):
                        ...
                        evaluate_metrics['task_progress'] = 1
                        write_data_to_csv(row['test_condition'], 'probability_based', len(target_points), evaluate_metrics)
                        break
                    else:
                        target_point = Vector(target_points[target_sequence])
                else:
                ...
                if len(trajectory) >= 10:
                    ...
                    for position in trajectory:
                        ...
                        while set_control:
                            agent_state = robot.get_effector_states()
                            if (Vector(list(position)) - agent_state['pos']).length <= 0.001:
                                break
                            else:
            ...
            while set_planning:
                ...
                if (target_point - agent_state['pos']).length <= 0.005:
                    ...
                    if target_sequence == len(target_points):
                        print("the last target point!")
                        evaluate_metrics['task_progress'] = 1
                        write_data_to_csv(row['test_condition'], 'model_based', len(target_points), evaluate_metrics)
                        break
                    else:
                        target_point = Vector(target_points[target_sequence])
                else:
